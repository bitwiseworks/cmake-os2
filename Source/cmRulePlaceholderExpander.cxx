  ...
  std::string const& variable)
{
  ...
  if (this->ReplaceValues->CMTargetName) {
    if (variable == "OS2_DEF_VERSION") {
      ...
      if (this->ReplaceValues->OS2DefVersion &&
          strlen(this->ReplaceValues->OS2DefVersion) > 0) {
        return this->ReplaceValues->OS2DefVersion;
      }

      if (this->ReplaceValues->Version && strlen(this->ReplaceValues->Version) > 0) {
        return this->ReplaceValues->Version;
      }
    ...
    if (variable == "OS2_DEF_PATCH") {
      if (this->ReplaceValues->OS2DefPatch &&
          strlen(this->ReplaceValues->OS2DefPatch) > 0) {
        return this->ReplaceValues->OS2DefPatch;
      } else {
        return "0";
      }
    }
    ...
    if (variable == "OS2_DEF_VENDOR") {
      if (this->ReplaceValues->OS2DefVendor &&
          strlen(this->ReplaceValues->OS2DefVendor) > 0) {
        return this->ReplaceValues->OS2DefVendor;
      } else {
    ...
    if (variable == "OS2_DEF_EXEType") {
      if (this->ReplaceValues->OS2DefExeType) {
        return this->ReplaceValues->OS2DefExeType;
      } else {
        return "";
      }
    }
    ...
    if (variable == "OS2_DEF_EXEStack") {
      if (this->ReplaceValues->OS2DefExeStack) {
        return this->ReplaceValues->OS2DefExeStack;
      } else {
        return "";
      }
    }
